...
class OverlayApp extends Globals {
    ...
    createCheckboxes = () => {
        this.injectCSS('div[role=presentation] {height: calc(100vh - 150px); top:-100px;};#div_maestro_ext_blackout {display: flex;} @media screen and (max-width: 1200px) {#div_maestro_ext_blackout {display: none !important;}}#div_maestro_ext_blinder {display: flex;} @media screen and (max-width: 1041px) {#div_maestro_ext_blinder {display: none !important;}}#div_maestro_ext_strobe {display: flex;} @media screen and (max-width: 882px) {#div_maestro_ext_strobe {display: none !important;}}#div_maestro_ext_fog {display: flex;} @media screen and (max-width: 723px) {#div_maestro_ext_fog {display: none !important;}}#div_maestro_ext_effect {display: flex;} @media screen and (max-width: 524px) {#div_maestro_ext_effect {display: none !important;}}');
